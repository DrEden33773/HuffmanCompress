 ...
 * @brief an implementation of HuffmanTree
 * @version 0.1
 * @date 2022-11-09
 *
...
public:
    ...
    using CharStreamBitCodeType = std::string;
...
private:
    ...
    struct NodeInfo {
        ...
        CharStreamBitCodeType bit_code {};
    ...
    std::unordered_map<T, CharStreamBitCodeType> BitCodeMap;
...
public:
    ...
    void build_bit_code_map() {
        for (int idx = 0; idx < num_of_input_node; ++idx) {
            ...
            const CharStreamBitCodeType& curr_bit_code = curr.bit_code;
